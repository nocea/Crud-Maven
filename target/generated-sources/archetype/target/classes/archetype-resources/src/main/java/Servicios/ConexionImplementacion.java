...
public class ConexionImplementacion implements ConexionInterfaz {
	...
	private String[] DatosConexion() {
		...
		try {
			...
			propiedadesCon.load(new FileInputStream("C:${symbol_escape}${symbol_escape}Users${symbol_escape}${symbol_escape}Puesto10${symbol_escape}${symbol_escape}Desktop${symbol_escape}${symbol_escape}GITHUB${symbol_escape}${symbol_escape}${artifactId}${symbol_escape}${symbol_escape}src${symbol_escape}${symbol_escape}main${symbol_escape}${symbol_escape}java${symbol_escape}${symbol_escape}Util${symbol_escape}${symbol_escape}conexionBBDD.properties"));
